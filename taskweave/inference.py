...
from taskweave.config import TestOptions
from taskweave.model import build_model
from taskweave.span_utils import span_cxw_to_xx
from taskweave.start_end_dataset import StartEndDataset, start_end_collate, prepare_batch_inputs
from taskweave.start_end_dataset_audio import \
    StartEndDataset_audio, start_end_collate_audio, prepare_batch_inputs_audio
from taskweave.postprocessing_taskweave import PostProcessorDETR
...
def compute_mr_results(model, eval_loader, opt, epoch_i=None, criterion=None, tb_writer=None):
    ...
    for batch in tqdm(eval_loader, desc="compute st ed scores"):
        ...
        # print("[hd_log_var,mr_log_var]",[hd_log_var,mr_log_var])
